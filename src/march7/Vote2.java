...
public class Vote2 {
    public static void main(String[] args) {
        Map<String, String> inputMap = makeInputMap();

        Map<String, VoterVO> sortedMap = makeSortedMap(inputMap);


        //sortedList 리스트를 이용해서 정렬하기
        List<VoterVO> sortedList = makeSortedList(sortedMap);
    ...
    public static Map<String, VoterVO> makeSortedMap(Map<String, String> inputMap){
    ...
    public static List<VoterVO> makeSortedList(Map<String, VoterVO> sortedMap){
        //sortedList 리스트를 이용해서 정렬하기
    ...
    public static void printSortedList(List<VoterVO> sortedList){
        int rank =0;
