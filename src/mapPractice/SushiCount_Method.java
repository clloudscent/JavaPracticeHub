...
public class SushiCount_Method {
    public static void main(String[] args) {
        //이름, 초밥
        //초밥, 횟수, (선택한사람 이름)
        Map<String, String> inputMap = inputMap();

        Map<String, SushiVO> sushiVOMap = makeSushiVOMap(inputMap);

        //sushiVO 정렬

       List<SushiVO> resultList = makeResultList(sushiVOMap);
    ...
    public static Map<String,SushiVO> makeSushiVOMap(Map<String, String> inputMap){
    ...
    public static List<SushiVO> makeResultList(Map<String, SushiVO> sushiVOMap){
    ...
    public static void sortResultList(List<SushiVO> resultList){
    ...
    public static void showResult(List<SushiVO> resultList){
        for (int i =0; i<resultList.size(); i++){
            //초밥, 횟수, (선택한사람 이름)
