        ...
        while (isRunnable) {
            ...
            switch (inputNum) {
                case "1":
                    ...
                    log.info("account is created with "+account.toString());
                    break;
                ...
                case "3":
                    ...
                    for (int i = 0; i < index; i++) {
                        if (accountArray[i].getPassword().equals(passwordCheck)) {
                            ...
                            log.warn("Wrong Account Info Entered. - "+currentAccountNum);
                        }
                    }
                    break;
                            ...
                            if (accountArray[i].getPassword().equals(passwordCheck2)) {
                                ...
                                if (accountForWithdraw.equals(accountArray[i].getAccountNumber())) {
                                    if (withdrawAmount > accountArray[i].getBalance()) {
                                        ...
                                        log.warn("Wrong Withdraw Requested. "+accountForWithdraw);
                                        break;
                                    }
                                ...
                                log.warn("Wrong Account Info Entered. - "+accountForWithdraw);
                                break;
                            }
                        }
                    }
