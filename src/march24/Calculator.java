...
//            System.out.println("input.length(): "+input.length()+", i: "+i);
        ...
        for (int i = 0; i < operatorList.size(); i++) {
            ...
            if (operatorList.get(i).equals("=")) {
                ...
                if (operatorList.get(i).equals("+")) {
                    result += plus(numList.get(i), numList.get(i + 1));
                } else if (operatorList.get(i).equals("-")) {
                    result -= minus(numList.get(i), numList.get(i + 1));
                } else if (operatorList.get(i).equals("*")) {
                    result *= multiply(numList.get(i), numList.get(i + 1));
                } else if (operatorList.get(i).equals("/")) {
                    result /= division(numList.get(i), numList.get(i + 1));
                }
